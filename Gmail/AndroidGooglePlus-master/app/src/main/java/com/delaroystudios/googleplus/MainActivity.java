package com.delaroystudios.googleplus;
...
import com.delaroystudios.googleplus.R;
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.disconnect_button:
                Toast.makeText(this, "Acceso denegado para Gmail, ahorita no joven", Toast.LENGTH_LONG).show();
                gPlusRevokeAccess();

            case R.id.frnd_button:
                Toast.makeText(this, "Iniciar Sesión", Toast.LENGTH_LONG).show();
